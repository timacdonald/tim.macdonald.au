...
Have you used a lottery for something interesting? Hit me up on <a href="{{ $page->profiles['twitter'] }}">Twitter</a> - I'd love to hear what you've done with one in your applications.
