...
const addHeadingLinks = () => {
 document.querySelectorAll('article .rich-text h1, article .rich-text h2, article .rich-text h3, article .rich-text h4, article .rich-text h5, article .rich-text h6').forEach(addHeadingLink)
}
...
const addAsyncDocReadyListener = (callback) => {
...
addAsyncDocReadyListener(onPageReady)
